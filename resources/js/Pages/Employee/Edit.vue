...
const form = useForm({
    ...
    ein: props.employees.ein,
    position: props.employees.position,
    departmen_division: props.employees.departmen_division,
    start_date: props.employees.start_date,
    employment_status: props.employees.employment_status,
    base_salary: props.employees.base_salary,
    bank_account: props.employees.bank_account,
});

const updateEmployee = () => {
    const res = form.put(route("employees.update", props.employees.id));
    if (res) {
        form.reset();
    }
};
